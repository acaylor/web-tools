...
export const useCommandPaletteStore = defineStore('command-palette', () => {
  ...
  const searchOptions: PaletteOption[] = [
    ...
    },
    {
      ...
      href: 'https://github.com/acaylor/web-tools',
      category: 'External',
      description: 'View the source code of web-tools on Github.',
      keywords: ['github', 'repo', 'repository', 'source', 'code'],
      icon: GithubIcon,
    },
    {
      name: 'Report a bug or an issue',
      description: 'Report a bug or an issue to help improve web-tools.',
      href: 'https://github.com/acaylor/web-tools/issues/new',
      category: 'Actions',
    ...
    {
      name: 'About',
      description: 'Learn more about Web Tools.',
      to: '/about',
      category: 'Pages',
